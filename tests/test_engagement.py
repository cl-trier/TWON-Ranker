...
def test_count_abs():
    assert modules.Engagement(func='count_based', log_normalize=False)(items=OBSERVATIONS) == N


def test_count_log():
    assert modules.Engagement(func='count_based', log_normalize=True)(items=OBSERVATIONS) == math.log(N)
